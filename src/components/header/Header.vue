<template>
	<div class="box">
		<div class="nav">
				...
				<li>
					<Dropdown placement="bottom-start">
						<a href="javascript:void(0)">
							<Icon type="md-pin" class="icon"/> {{city}}
						</a>
			...
			<ul class="detail">
				<li class="first">
					你好，请<router-link>登录 <Icon type="md-person"></Icon>
					</router-link> |<span class="text-color-red">
						<router-link>免费注册 <Icon type="md-person-add"></Icon>
						</router-link>
					</span>
				</li>
				<li>
					<Dropdown>
						<p class="username-p">
							<Avatar class="person-icon" icon="person" size="small" /> <span class="username">马洪升</span>
						</p>
						<DropdownMenu slot="list">
							<div class="my-page">
				...
				<li>
					<router-link>网站导航</router-link>
				</li>
				<li>
					<router-link>意见反馈</router-link>
				</li>
				<li>
					<router-link>商城首页</router-link>
				</li>
			</ul>
		</div>
	</div>
