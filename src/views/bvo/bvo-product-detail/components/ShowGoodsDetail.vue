...
<script>
import ShowProductWarranty from '@/views/bvo/bvo-product-detail/components/ShowProductWarranty.vue';
export default {
  ...
  data () {
    return {
      ...
      productInfo: { // 商品详情
        ...
        setMeal: [],
        hot: [],
        goodsDetail: ["https://e-commerce-oss.oss-cn-beijing.aliyuncs.com/images/1593771713868.png","https://e-commerce-oss.oss-cn-beijing.aliyuncs.com/images/item-detail-2.jpg"],
        param: [{
          title:"商品名称:",
          content:"iPhone 7手机壳"
        },
